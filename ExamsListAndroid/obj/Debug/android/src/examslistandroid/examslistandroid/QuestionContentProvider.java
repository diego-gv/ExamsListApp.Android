...
public class QuestionContentProvider
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ExamsListAndroid.QuestionContentProvider, ExamsListAndroid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", QuestionContentProvider.class, __md_methods);
	}


	public QuestionContentProvider () throws java.lang.Throwable
	{
		super ();
		if (getClass () == QuestionContentProvider.class)
			mono.android.TypeManager.Activate ("ExamsListAndroid.QuestionContentProvider, ExamsListAndroid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
